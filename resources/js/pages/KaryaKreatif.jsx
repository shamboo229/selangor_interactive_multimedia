...
export default function KaryaKreatif() {
    return (
        <MultimediaLayout>
            ...
            <div className="space-y-8">
                <header className="border-b border-slate-200 dark:border-slate-800 pb-8">
                    <h1 className="text-4xl font-black tracking-tight dark:text-white">
                        Karya <span className="text-red-600">Kreatif</span>
                    </h1>
                    <p className="mt-4 text-slate-500 dark:text-slate-400 max-w-2xl">
                        Terokai pelbagai hasil karya kreatif digital, seni visual, dan inovasi multimedia dari bakat-bakat tempatan.
                    </p>
                </header>
