            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Manage public library assets and review community submissions.</p>
                    </div>
                    <Link
                                        ...
                                        {pendingAssets.map((sub) => (
                                            <tr key={sub.asset_id} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                                                ...
                                                <td className="px-6 py-4">
                                                    ...
                                                    <span className="inline-block mt-1 px-2 py-0.5 rounded text-[10px] uppercase font-bold bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400">
                                                        {sub.category}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4">
