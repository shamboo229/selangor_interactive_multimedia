        ...
        <div className="min-h-screen bg-slate-50 flex font-sans text-slate-900 selection:bg-red-500 selection:text-white">
            <aside className="w-[280px] bg-[#0b1121] text-slate-400 flex flex-col border-r border-slate-800 hidden lg:flex">
                ...
                <nav className="flex-1 px-4 py-8 space-y-1 overflow-y-auto">
                    ...
                    >
                        <svg className={`w-5 h-5 mr-3 ${currentUrl === '/admin' ? '' : 'opacity-70'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        Dashboard
                    </Link>
                    ...
                    >
                        <svg className={`w-5 h-5 mr-3 ${checkActive('/admin/assets') ? '' : 'opacity-70'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        Media & Assets
                    </Link>
                    ...
                    >
                        <svg className={`w-5 h-5 mr-3 ${checkActive('/admin/users') ? '' : 'opacity-70'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        Users & Roles
                    </Link>
                </nav>
